...
def set_background(png_file):
    ...
    return
# set_background('/home/ubuntu/anita_photo/2022_05_22/115d1232-d985-11ec-b255-859fa7354fc2-20211230mui_0.png')
...
image_file = st.file_uploader(
    "我們先來為今天留下美好的紀念吧！放張你最喜歡的 Anita 或是為今天留下一個紀念吧！ P.S.可以上傳多張照片唷！", accept_multiple_files=True)
...
submit = st.button("我答完了")

# Once the user has submitted, upload it to the Firebase database
if nickname and place and years and sentence and submit:
